 ...
 * @date 8/13/2020
 * @description SupComponent for AppComponent.  Component has the scope ActivityScope. Scoped object lives as long as its component it can be seen as Singleton in Subcomponent context
 */
